...
void upload::prepare()
{
	...
	booster::regex reext("^.*\\.(gif|jpe?g|bmp|png|mp4|avi|flv|f4v|webm|ogv|bz2|xz|gz|tar|rar|zip|7z|cab|docx?|xlsx?|pptx?|pdf|csv|txt)$", booster::regex::perl|booster::regex::icase);
